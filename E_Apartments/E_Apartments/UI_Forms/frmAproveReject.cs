...
{
    public partial class frmAproveReject : Form
    {
        public frmAproveReject()
        {
            InitializeComponent();
        }
        Lease_DTO dto = new Lease_DTO();
        private void frmAproveReject_Load(object sender, EventArgs e)
        {
            Load_Table();
        }
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Columns.Count; i++)
            {
                ...
                decimal Total_Rental = Convert.ToDecimal(dataGridView1.Rows[e.RowIndex].Cells[10].Value.ToString()) * Convert.ToInt32(lblcreatedate.Text = dataGridView1.Rows[e.RowIndex].Cells[16].Value.ToString());
                lbltotalrental.Text = Total_Rental.ToString();
